...
namespace mkrecv
{
  ...
  protected:
    ...
    std::size_t                        group_first;  // serial number of the first group (needed for index calculation)
    std::size_t                        group_step;   // the serial number difference between consecutive groups
